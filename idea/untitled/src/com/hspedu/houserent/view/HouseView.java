...
public class HouseView {
    ...
    public void update(){
        ...
        System.out.println("请选择待修改房屋编号(-1表示u提出)");
        ...
        String name = Utility.readString(8,"");//这里如果用户直接回车表示不修改信息
        if (!"".equals(name)) {
            house.setName(name);
        }
    ...
    public void addHouse(){
        ...
        System.out.print("月租: ");
        int rent = Utility.readChar();
        System.out.println("状态");
        String state = Utility.readString(3);
        //创建一个新的House对象，注意id，是系统分配的 用户不能输入10000
    ...
    public void listHouse(){
        ...
        for (int i = 0; i < houses.length; i++){
            if (houses[i] == null){//如果为null就不用再显示了
                break;
            }
